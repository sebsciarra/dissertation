...
% Define lscape page style for landscape pages
% Automatically apply lscape page style at the beginning of landscape environment
...
\thead[lt]{Middle and extreme \\ 
                                                   ...
                                                   Table \ref{tab:summary-table-mid-ext-exp2})} & \thead[lt]{NM $\boldsymbol{\ge}$ 5 with
                                           \textit{N} $\boldsymbol{\ge}$ 200 or \\
                                           NM  $\boldsymbol{\in}$ \{5, 7\} with \textit{N} = 100} & No cells & Largest improvements in bias and precision with NM = 5 & 14.96 & 9.92 & 15.94 & 10.13\\
\bottomrule
\insertTableNotes
\end{longtable}
\end{ThreePartTable}
